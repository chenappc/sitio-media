        ...
        async function generarImagenYSubir(page: PageData): Promise<{ imagenUrl: string | null }> {
          ...
          if (imagenBase64) {
            if (imagenReferenciaPersonajes) {
              promptParaGemini =
                "You will receive two images. Image 1 is a CHARACTER REFERENCE — it shows who the recurring characters look like. Image 2 is the SCENE TO RECREATE.\n\nRules:\n1. Look at Image 2 carefully and count how many people are in it\n2. Recreate ONLY the people that appear in Image 2 — do not add or remove anyone\n3. For each person in Image 2, match them to the most similar character in Image 1 and render them with that character's exact face, hair, age, and clothing\n4. Recreate the setting, composition, lighting and atmosphere from Image 2 cinematically\n5. Do not include any weapons, guns, knives, firearms, or violent imagery of any kind\n\nOutput: a single cinematic photorealistic scene.";
            } else {
              promptParaGemini =
